...
W = array([2,1,2],float)
a = zeros((3,3))
# values assigned from values in problem
...
for r in R:
   a = zeros([3,3])
   # values assigned fro, given equations
   a[0,:] = [50 + r, -r, -30]
   a[1,:] = [-r, 65 + r, -15]
   a[2,:] = [-30, -15, 45]
...
a = zeros([4,4])
# values derived from given equations
a[0, :] = [50 + 30, -50, -30, 0]
a[1, :] = [-50, 50 + 15 + 25 + 10, -10, -25]
a[2, :] = [-30, -10, 30 + 10 + 20 + 5, -20]
a[3, :] = [0, -25, -20, 20 + 25 + 55]
